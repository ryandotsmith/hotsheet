  ...
  function clickFunction() {
    ...
    e.find("form").submit(function(){
      ...
      jQuery.ajax({
        "url" : url,
        "type" : "post",
        "data" : "edit_in_place=true&_method=put&"+objectName+'['+attributeName+']='+encodeURIComponent(value)+(window.rails_authenticity_token ? "&authenticity_token="+encodeURIComponent(window.rails_authenticity_token) : ''),
        "success" : function(){
          jQuery.ajax({
            "url" : url,
